...
| Status | Active |
| Anonymous | No |
| Display Policy | "SWAT Leadership Project Captains and All Volunteers" (single existing policy — checks SWAT Leadership OR SWAT Project Captains team OR has Volunteer Id attribute) |
